...
$allAnimalsInfo = $animalModel->getAllAnimal();
...
// Rendu de la vue
render(__DIR__ . "/views/$pagePath", compact('pageTitle', 'users', 'counts', 'countSpecies', 'species', 'date', 'countPosts', 'countUsers', 'countRaces', 'countAnimals', 'allAnimalsInfo', 'animals', 'races', 'posts', 'contacts'));
